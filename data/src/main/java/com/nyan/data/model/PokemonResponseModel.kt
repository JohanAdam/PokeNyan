...
fun mapToPokemonDetailEntity(item: PokemonResponseModel): PokemonDetailEntity {

	val types = item.types?.map {
		com.nyan.domain.entity.TypesItem(
			slot = it?.slot,
			type = com.nyan.domain.entity.Type(
				name = it?.type?.name,
				url = it?.type?.url
			)
		)
	...
	val sprites = com.nyan.domain.entity.Sprites(
		backDefault = item.sprites?.backDefault,
		frontDefault = item.sprites?.frontDefault
	)

	val abilities = item.abilities?.map {
		com.nyan.domain.entity.AbilitiesItem(
			isHidden = it?.isHidden,
			ability = com.nyan.domain.entity.Ability(
	...
	val stats = item.stats?.map {
		com.nyan.domain.entity.StatsItem(
			stat = com.nyan.domain.entity.Stat(
				it?.stat?.name,
				it?.stat?.url
			),
	...
	val moves = item.moves?.map {
		com.nyan.domain.entity.MovesItem(
			move = com.nyan.domain.entity.Move(
				name = it?.move?.name,
				url = it?.move?.url
			)
		)
